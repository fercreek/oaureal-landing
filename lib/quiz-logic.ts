...
export const ARCHETYPES_FULL: Record<ArchetypeId, ArchetypeFull> = {
  exhausto: {
    ...
    quest: {
      ...
      reward: 'Mayor sensación de descanso y disponibilidad interna',
      note: "El descanso empieza por el ritmo, no por 'lograr dormir rápido'",
    },
    warning: "No es falta de capacidad. Es un sistema que ha permanecido activo durante demasiado tiempo.",
