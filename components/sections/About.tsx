  ...
  return (
    <section id="about" className="py-24 px-6 bg-black">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        <div>
          <h2 className="text-4xl font-serif mb-8 italic">¿Qué es Oaureal?</h2>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={item} className="flex items-center gap-3 text-[#a5f0fa]">
                <CheckCircle size={18} />
        ...
        <div className="relative p-1 bg-gradient-to-tr from-[#011797] to-[#54008c] rounded-[40px]">
          <div className="bg-black rounded-[38px] overflow-hidden">
            <img 
